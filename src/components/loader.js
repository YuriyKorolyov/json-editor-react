!function() {
    ...
    function() {
        ...
        function p(l, p, _, b) {
            ...
            function() {
                ...
                if (void 0 === l.jivo_magic_var) {
                    ...
                    var S, j, C, I, L, E, T, N, O, B, A = {
                        ...
                        scriptSrc: null
                    }, k = navigator.userAgent.toLowerCase(), W = /iPhone|iPad|iPod|Android|Windows Phone/i.test(k), x = p.createElement("iframe"), M = p.createElement("div"), H = 0, R = 0, D = 0, U = [], J = !1, q = ae(), P = JSON.parse('["AF","CG","CF","GW","ER","IR","IQ","KP","LR","LB","LY","ML","CU","PS","SO","SD","SY","ZW","YE"]') || null, z = JSON.parse('["127-129-12k-12i-12c-12h","12e-12i-12e-124-12c-12h","131-12e-12l-12m-124-12b-12c","124-12g-12o-129-12m-124-12g-12c-12h","127-124-12s-12c-12s","12g-124-12k-12c-12p-12n-124-12h-124","3n-12j-124-12d-12l","12g-129-12o-129-128-12k-12i-12h"]') || null, G = !0;
                    ye("Initialization"),
                    l.__jivoBundleOnLoad = function(e) {
                        ...
                        function() {
                            ...
                            M.appendChild(x),
                            C ? C.parentNode.insertBefore(M, C.nextSibling) : p.body.appendChild(M);
                            ie()
                        }()
                    }
                    ,
                    l.__jivoBundleInit = function(e) {
                        ...
                        function() {
                            ...
                            if (!e)
                                throw y.error("Cannot get bundle script element"),
                    ...
                    A.store = q,
                    A.setInStore = de;
                    var V, X = !1, F = function(e) {
                        try {
                            e.blockedURI && -1 !== e.blockedURI.indexOf("jivosite") && (X = !0,
                            p.removeEventListener("securitypolicyviolation", F))
                        } catch (e) {}
                    }
                    .bind(this);
                    try {
                    ...
                    ue(),
                    !(!(V = N) || (!/^\d+$/.test(V) || 0 === V) && 10 != V.length) || (N = null,
                    T = null,
                    y.error("Widget id is not valid.")),
                    T || (N = null,
                    T = null,
                    y.error("Widget codehost is not valid")),
                    Q(f, 5),
                    function() {
                        (q = ae()).geoWidgetInfo.widgetId && (N = q.geoWidgetInfo.widgetId,
                        q = ae(),
                        T = q.configHost);
                        de("isNewCode", J),
                        A.store = q
                    ...
                    N && T ? (ye("widgetId:", N, "configHost:", T),
                    $(ce())) : N && T || (Q(m, 5),
                    y.error("Failed to evaluate the widgetId or configHost"))
                }
            } else
                y.log("Not supported browser");
            function $(e, t) {
                if (U.push(e),
                ++D > 4) {
                    ...
                    l.__jivoOnError(n)
                } else if (ye("Loading config from", e),
                q.deletedInfo.widgetId && q.deletedInfo.widgetId === N && q.deletedInfo.resolveTime && parseInt(q.deletedInfo.resolveTime) >= (new Date).getTime())
                ...
                else if (e && -1 != e.indexOf("src="))
                    y.error("This widget code src is wrong.");
                else {
                    ...
                    i.onreadystatechange = function() {
                        if (4 === i.readyState)
                            if (200 === i.status) {
                                var e = Le(pe(i));
                                e ? (ye("Config is loaded", e),
                                e.isDeleted ? me() : t ? (e.chat_mode = t.chat_mode,
                                e.options = t.options,
                                e.botmode = t.botmode,
                                e.geoip = t.geoip,
                                e.maintenance = !!t.maintenance,
                                ee(e, null)) : function(e, t) {
                                    ...
                                    n.onreadystatechange = function() {
                                        if (4 === n.readyState)
                                            if (200 === n.status) {
                                                ...
                                                e.options = 0,
                                                t(null),
                                                480 == n.status && (e.maintenance = !0,
                                                ye("Site is under maintenance, try again later.")),
            ...
            function ee(e, t) {
                if (ye("checkConfig", e.config_updated_ts, t),
                e.isDeleted)
                    me();
                else if (function() {
                    var e = navigator.userAgent.toLowerCase();
                    ...
                    if (t && e.config_updated_ts && e.config_updated_ts != t)
                        return ye("update configUpdatedTs in store", t),
                        de("configUpdatedTs", t),
                        $(ce(), e);
                    if (e.regions && !q.isChatStarted) {
                        var n = function(e) {
                            var t, n, o = e.regions, r = fe(e.geoip);
                            if (o) {
                                ...
                                if (n)
                                    return n;
                                if (t)
                                    return ge(t, "default", e.geoip)
                            }
                        }(e);
                        if (n.widgetId !== N)
                            return ye("Wrong geo-widget widgetId", N),
                            de("geoWidgetInfo", n),
                            N = n.widgetId,
                            void $(ce())
                    }
                    if ((Z = e.ab_segment) && Z.name && Z.host && Z.staticHost && 1 !== e.site_id)
                        if (ye("AB-testing segmentation is enabled in config"),
                        Y = function(e, t) {
                            var n = q.abTesting
                              , o = !1;
                            o = n && n.name === e.name ? n.match : function(e, t) {
                                if (ye('Check for criteria match of test "' + e.name + '"'),
                                e.device) {
                                    if (!function(e) {
                                        if ("desktop" === e)
                                            return Ce() && !Ie();
                                        ...
                                        return ye('Segment "' + e.name + '" is NOT matched. Criteria: device'),
                                        !1
                                }
                                if (e.locale) {
                                    if (!(e.locale === t.locale))
                                        return ye('Segment "' + e.name + '" is NOT matched. Criteria: locale'),
                                        !1
                                }
                                if (e.percentage) {
                                    if (!(n = e.percentage,
                                    Math.random() <= .01 * n))
                                        return ye('Segment "' + e.name + '" is NOT matched. Criteria: percentage'),
                                        !1
                                }
                                var n;
                                return ye('Segment "' + e.name + '" is matched!'),
                                !0
                            }(e, t);
                            return de("abTesting", {
                                name: e.name,
                        ...
                        Y) {
                            ...
                            var o = "//" + Z.host;
                            ye('Setting new base_url. Was: "' + e.base_url + '". New: "' + o + '".'),
                            e.base_url = o
                        } else
                            ye("Ab-testing segment is NOT matched");
                    else
                        de("abTesting", null),
                    ...
                    !function(e) {
                        ...
                        function() {
                            ...
                            throw ye("Host is blacklisted", l.location.host),
                            new Error("Placing widget is forbidden on " + l.top.location.host);
                        if (t = S.geoip.split(";")[0],
                        P.indexOf(t) >= 0)
                        ...
                        if (!e.disable_stop_words && function() {
                            ...
                            return K(v),
                            void ye("Init error, code 1015.");
                        if (W && S.disable_mobile)
                            return void ye("Mobile widget is disabled");
                        var t;
                        "complete" == p.readyState ? (ye("DOM Ready Complete."),
                        te()) : q.bundleLoaded && q.buildNumber == S.build_number ? (ye("DOM Ready is not complete. Bundle loaded and BuildNumber is correct."),
                        "interactive" == p.readyState ? (ye("DOM Ready is interactive. Bundle loaded and BuildNumber is correct."),
                        te()) : (ye("DOM Ready is not interactive. Bundle loaded and BuildNumber is correct. Add listener on DOMContentLoaded."),
                        d(l, "DOMContentLoaded", te))) : (ye("DOM Ready is not complete. Bundle is not loaded. Add listener on window.onload"),
                        de("bundleLoaded", !1),
                        d(l, "load", te))
                    }(e)
                }
                ...
                function() {
                    ...
                    d(l, "message", (function(e) {
                        if (e && e.data && "object" == typeof e.data) {
                            ...
                            S && 1 === S.logs && y && y.log && y.log("Error receive postMessage, window message event is empty.")
                    }
                    ))
                }()
            }
            function ne() {
                var e = be();
                ye("loadBundleAfterWait", e, A),
                c(ne),
                re(e)
            }
            function oe() {
                var e, t = be();
                if (A.store.isChatStarted || !S.enable_bundle_wait || ("jivo.chat" === (e = l.location).host || e.pathname.includes("/chatpage/")))
                    ye("startLoadBundle", t),
                    re(t);
                else {
                    ye("addWaitActions");
                    try {
            ...
            function re(e) {
                ...
                n.onerror = function() {
                    ...
                    p.getElementById("jcont") && function(e, t, n) {
                        if (clearTimeout(I),
                        ++R >= 3) {
                            if (ye("Bundle load retries count is exceeded"),
                            X)
                                return void y.error("Widget not loaded due CSP security policy.");
            ...
            function ce() {
                var e = "";
                return ye("getConfigUrl", q.configUpdatedTs),
            ...
            function ue() {
                ...
                if (A.scriptSrc = r,
                r && (r.match(/&lt;/) || r.match(/scr=/)))
                    ye("Invalid codeHost", r);
                else {
            ...
            function me() {
                ...
                de("configHost", null),
                q.geoWidgetInfo.widgetId || q.isChatStarted ? (de("geoWidgetInfo", ge(null, null, null)),
                de("isChatStarted", null),
                he()) : (de("deletedInfo", {
                    widgetId: N,
                    resolveTime: ((new Date).getTime() + 864e5).toString()
                }),
                y.error("Widget " + N + " is permanently removed. Host: " + T),
                K(h))
            }
            function ve(e) {
                ye("Config loading error:", e ? "parse" : "request"),
                de("geoWidgetInfo", ge(null, null, null)),
                de("isChatStarted", null),
                de("configHost", null),
                e || he()
            }
